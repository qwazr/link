...
public class ComponentsManager {
	...
	public ComponentsManager registerServices() throws IOException, ClassNotFoundException {
		ServiceLoader.load(LinkComponent.class, Thread.currentThread().getContextClassLoader()).forEach(this::register);
		return this;
	}

	final void register(LinkComponent componentClass) {
