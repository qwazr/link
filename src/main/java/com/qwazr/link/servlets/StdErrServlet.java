...
public class StdErrServlet extends AbstractServlet {

    private final ScriptServiceInterface scriptService;

    public StdErrServlet(final FreeMarkerTool freemarker, final ScriptServiceInterface scriptService) {
        super(freemarker);
    ...
    protected void doGet(final Transaction transaction) throws IOException {
        ...
        try (final InputStream inputStream = scriptService.getRunErr(transaction.getRequestParameter("id"))) {
